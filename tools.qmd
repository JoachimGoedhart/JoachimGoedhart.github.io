...
EZReverse is a web app for inverting the background of images. The original  [EZreverse](https://www.biorxiv.org/content/10.1101/2024.05.27.594095v1) version was written in (Shiny for) Python and this version is converted into a standalone app that should be much faster: [EZreverse.html](EZreverse.html)


![](images/logo.png){width=200px fig-align="left"}
